...
export default function SocialOrderButtons({
  productName, price, currency, whatsapp, instagram, facebook, compact = false
}: SocialOrderButtonsProps) {
  const formattedPrice = `${currency}${price.toLocaleString()}`
  const message = `Hi! I'm interested in ordering the *${productName}* (${formattedPrice}). Is it available?`
  ...
  const handleFacebook = () => {
    const page = facebook.replace('@', '')
    window.open(`https://m.me/${page}`, '_blank')
  }
    ...
    return (
      <div className="flex gap-1.5">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg bg-[#1a1a1e] border border-[#2e2e35] text-[#25D366] hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all duration-200 text-xs font-medium"
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg bg-[#1a1a1e] border border-[#2e2e35] text-[#E1306C] hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:text-white hover:border-transparent transition-all duration-200 text-xs font-medium"
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg bg-[#1a1a1e] border border-[#2e2e35] text-[#1877F2] hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all duration-200 text-xs font-medium"
